              ...
              <Swiper {...swiperOptions} className="swiper-wrapper">
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item1.svg"
                        alt="icon-img"
                ...
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item2.svg"
                        alt="icon-img"
                      />
                    </div>
                    <div className="content">
                ...
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item3.svg"
                        alt="icon-img"
                      />
                    </div>
                    <div className="content">
                ...
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item4.svg"
                        alt="icon-img"
                      />
                    </div>
                    <div className="content">
                ...
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item5.svg"
                        alt="icon-img"
                      />
                    </div>
                    <div className="content">
                ...
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item6.svg"
                        alt="icon-img"
                      />
                    </div>
                    <div className="content">
                ...
                <SwiperSlide>
                  <div className="service-box-items">
                    <div className="icon">
                      <img
                        src="/assets/img/service/icon/item7.svg"
                        alt="icon-img"
                      />
                    </div>
                    <div className="content">
